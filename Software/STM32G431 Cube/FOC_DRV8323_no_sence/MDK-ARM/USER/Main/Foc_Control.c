 ...
 * @LastEditTime: 2025-03-15 23:34:05
 * @FilePath: \FOC_DRV8323_no_sence\MDK-ARM\USER\Main\Foc_Control.c
...
void Position_Nonlinear_Observer(void)
{
    
}//位置非线性观测器

void Speed_Observer(void)
{
